...
After the old [project repository](https://ribbon.codeplex.com) has gone inactivity, some volunteers of the fans of this project re-host the source code at [https://officeribbon.codeplex.com/] and continue to provide support, improve, develop and keeping it alive. Until today, multiple changes, tweak, bugs fixes have been added/enhanced. Another article was written by the group at  [codeproject.com](https://www.codeproject.com/Articles/364272/Easily-Add-a-Ribbon-into-a-WinForms-Application-Cs) to further explain the implementation of the plugin in WinForms.
